...
public class Browser {
    ...
    private static final Cursor getVisitedLike(ContentResolver cr, String url) {
        ...
        return cr.query(BrowserContract.History.CONTENT_URI, new String[]{BrowserContract.History._ID, BrowserContract.History.VISITS},
    ...
    public static final void truncateHistory(ContentResolver cr) {
        ...
        try {
            ...
            cursor = cr.query(BrowserContract.History.CONTENT_URI,
                    new String[]{BrowserContract.History._ID, BrowserContract.History.URL, BrowserContract.History.DATE_LAST_VISITED},
            ...
            if (cursor.moveToFirst() && cursor.getCount() >= MAX_HISTORY_COUNT) {
                ...
                for (int i = 0; i < TRUNCATE_N_OLDEST; i++) {
                    cr.delete(ContentUris.withAppendedId(BrowserContract.History.CONTENT_URI, cursor.getLong(0)),
                            null, null);
    ...
    private static final void deleteHistoryWhere(ContentResolver cr, String whereClause) {
        Cursor cursor = null;
        try {
            cursor = cr.query(BrowserContract.History.CONTENT_URI, new String[]{BrowserContract.History.URL}, whereClause,
                    null, null);
    ...
    public static final void deleteFromHistory(ContentResolver cr,
                                               String url) {
        cr.delete(BrowserContract.History.CONTENT_URI, BrowserContract.History.URL + "=?", new String[]{url});
    }
