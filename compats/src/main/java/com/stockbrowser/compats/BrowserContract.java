...
/**
 * <p> The contract between the browser provider and applications. Contains the definition for the supported
 * URIS and columns. </p> <h3>Overview</h3> <p> BrowserContract defines an database of browser-related
 * information which are bookmarks, history, images and the mapping between the image and URL. </p>
 *
 * @hide
 */
public class BrowserContract {
	...
	/**
	 * An optional insert, update or delete URI parameter that allows the caller to specify that it is a sync
	 * adapter. The default value is false. If true the dirty flag is not automatically set and the
	 * "syncToNetwork" parameter is set to false when calling {@link ContentResolver#notifyChange(android
	 * .net.Uri,
	...
	/**
	 * A parameter for use when querying any table that allows specifying a limit on the number of rows
	 * returned.
	 *
	 * @hide
	 */
	...
	/**
	 * Generic columns for use by sync adapters. The specific functions of these columns are private to the
	 * sync adapter. Other clients of the API should not attempt to either read or write these columns.
	 *
	 * @hide
	 */
	...
	/**
	 * Columns that appear when each row of a table belongs to a specific account, including sync information
	 * that an account may need.
	 *
	 * @hide
	 */
	interface SyncColumns extends BaseSyncColumns {
		/**
		 * The name of the account instance to which this row belongs, which when paired with {@link
		 * #ACCOUNT_TYPE} identifies a specific account. <P>Type: TEXT</P>
		 */
		public static final String ACCOUNT_NAME = "account_name";

		/**
		 * The type of account to which this row belongs, which when paired with {@link #ACCOUNT_NAME}
		 * identifies a specific account. <P>Type: TEXT</P>
		 */
		public static final String ACCOUNT_TYPE = "account_type";

		/**
		 * String that uniquely identifies this row to its source account. <P>Type: TEXT</P>
		 */
		public static final String SOURCE_ID = "sourceid";

		/**
		 * Version number that is updated whenever this row or its related data changes. <P>Type: INTEGER</P>
		 */
		public static final String VERSION = "version";

		/**
		 * Flag indicating that {@link #VERSION} has changed, and this row needs to be synchronized by its
		 * owning account. <P>Type: INTEGER (boolean)</P>
		 */
		public static final String DIRTY = "dirty";

		/**
		 * The time that this row was last modified by a client (msecs since the epoch). <P>Type: INTEGER</P>
		 */
	...
	interface CommonColumns {
		...
		/**
		 * This column is valid when the row is a URL. The history table's URL can not be updated. <P>Type:
		 * TEXT (URL)</P>
		 */
		public static final String URL = "url";

		/**
		 * The user visible title. <P>Type: TEXT</P>
		 */
		public static final String TITLE = "title";

		/**
		 * The time that this row was created on its originating client (msecs since the epoch). <P>Type:
		 * INTEGER</P>
		 *
		 * @hide
		 */
	...
	interface ImageColumns {
		/**
		 * The favicon of the bookmark, may be NULL. Must decode via {@link BitmapFactory#decodeByteArray}.
		 * <p>Type: BLOB (image)</p>
		 */
		public static final String FAVICON = "favicon";

		/**
		 * A thumbnail of the page,may be NULL. Must decode via {@link BitmapFactory#decodeByteArray}.
		 * <p>Type: BLOB (image)</p>
		 */
		public static final String THUMBNAIL = "thumbnail";

		/**
		 * The touch icon for the web page, may be NULL. Must decode via {@link
		 * BitmapFactory#decodeByteArray}. <p>Type: BLOB (image)</p>
		 */
	...
	interface HistoryColumns {
		/**
		 * The date the item was last visited, in milliseconds since the epoch. <p>Type: INTEGER (date in
		 * milliseconds since January 1, 1970)</p>
		 */
		public static final String DATE_LAST_VISITED = "date";

		/**
		 * The number of times the item has been visited. <p>Type: INTEGER</p>
		 */
	...
	interface ImageMappingColumns {
		/**
		 * The ID of the image in Images. One image can map onto the multiple URLs. <P>Type: INTEGER
		 * (long)</P>
		 */
		public static final String IMAGE_ID = "image_id";

		/**
		 * The URL. The URL can map onto the different type of images. <P>Type: TEXT (URL)</P>
		 */
		public static final String URL = "url";
	}
	...
	public static final class Bookmarks implements CommonColumns, ImageColumns, SyncColumns {
		...
		/**
		 * The type of the item. <P>Type: INTEGER</P> <p>Allowed values are:</p> <p> <ul> <li>{@link
		 * #BOOKMARK_TYPE_BOOKMARK}</li> <li>{@link #BOOKMARK_TYPE_FOLDER}</li> <li>{@link
		 * #BOOKMARK_TYPE_BOOKMARK_BAR_FOLDER}</li> <li>{@link #BOOKMARK_TYPE_OTHER_FOLDER}</li> <li>{@link
		 * #BOOKMARK_TYPE_MOBILE_FOLDER}</li> </ul> </p> <p> The TYPE_BOOKMARK_BAR_FOLDER, TYPE_OTHER_FOLDER
		 * and TYPE_MOBILE_FOLDER can not be updated or deleted.</p>
		 */
		...
		/**
		 * Query parameter to use if you want to see deleted bookmarks that are still around on the device
		 * and
		...
		/**
		 * Flag indicating if an item is a folder or bookmark. Non-zero values indicate a folder and zero
		 * indicates a bookmark. <P>Type: INTEGER (boolean)</P>
		 *
		 * @hide
		 */
		public static final String IS_FOLDER = "folder";
		/**
		 * The ID of the parent folder. ID 0 is the root folder. <P>Type: INTEGER (reference to item in the
		 * same table)</P>
		 */
		...
		/**
		 * The position of the bookmark in relation to it's siblings that share the same {@link #PARENT}. May
		 * be negative. <P>Type: INTEGER</P>
		 *
		 * @hide
		 */
		public static final String POSITION = "position";
		/**
		 * The item that the bookmark should be inserted after. May be negative. <P>Type: INTEGER</P>
		 *
		 * @hide
		 */
		public static final String INSERT_AFTER = "insert_after";
		/**
		 * The source ID for the item that the bookmark should be inserted after. Read-only. May be negative.
		 * <P>Type: INTEGER</P>
		 *
		 * @hide
		 * @see #INSERT_AFTER
		...
		/**
		 * A flag to indicate if an item has been deleted. Queries will not return deleted entries unless you
		 * add the {@link #QUERY_PARAMETER_SHOW_DELETED} query paramter to the URI when performing your
		 * query.
	...
	public static final class Accounts {
		...
		/**
		 * The ID of the account's root folder. This will be the ID of the folder returned when querying
		 * {@link Bookmarks#CONTENT_URI_DEFAULT_FOLDER}. <P>Type: INTEGER</P>
		 */
	...
	/**
	 * <p> Stores images for URLs. </p> <p> The rows in this table can not be updated since there might have
	 * multiple URLs mapping onto the same image. If you want to update a URL's image, you need to add the
	 * new
	 * image in this table, then update the mapping onto the added image. </p> <p> Every image should be at
	 * least associated with one URL, otherwise it will be removed after a while. </p>
	 */
	public static final class Images implements ImageColumns {
		...
		/**
		 * The type of item in the table. <P>Type: INTEGER</P> <p>Allowed values are:</p> <p> <ul> <li>{@link
		 * #IMAGE_TYPE_FAVICON}</li> <li>{@link #IMAGE_TYPE_PRECOMPOSED_TOUCH_ICON}</li> <li>{@link
		 * #IMAGE_TYPE_TOUCH_ICON}</li> </ul> </p>
		 */
		public static final String TYPE = "type";
		/**
		 * The image data. <p>Type: BLOB (image)</p>
		 */
		public static final String DATA = "data";
		/**
		 * The URL the images came from. <P>Type: TEXT (URL)</P>
		 *
		 * @hide
		 */
	...
	/**
	 * <p> A table that stores the mappings between the image and the URL. </p> <p> Deleting or Updating a
	 * mapping might also deletes the mapped image if there is no other URL maps onto it. </p>
	 */
	...
	/**
	 * A combined view of bookmarks and history. All bookmarks in all folders are included and no folders are
	 * included.
	 *
	 * @hide
	 */
