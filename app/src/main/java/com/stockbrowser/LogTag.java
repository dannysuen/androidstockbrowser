...
public class LogTag {
	...
	/**
	 * Log when a page has finished loading with how much time the browser used to load the page. <p/> Note
	 * that a redirect will restart the timer, so this time is not always how long it takes for the user to
	 * load a page.
	 *
