...
import com.stockbrowser.BrowserWebView.OnScrollChangedListener;
...
/**
 * Helper class to manage when to show the URL bar based off of touch input, and when to begin the hide
 * timer.
 */
public class UrlBarAutoShowManager implements OnTouchListener, OnScrollChangedListener {
