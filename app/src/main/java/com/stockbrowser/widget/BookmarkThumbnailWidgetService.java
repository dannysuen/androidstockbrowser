...
import com.stockbrowser.compats.BrowserContract.Bookmarks;
...
public class BookmarkThumbnailWidgetService extends RemoteViewsService {
	...
	// 注释掉该方法实现，Context.getSharedPrefsFile没有
		...
		public RemoteViews getViewAt(int position) {
			...
			if (isFolder) {
				if (id == mCurrentFolder) {
					...
					views.setImageViewResource(R.id.thumb, R.drawable
							.thumb_bookmark_widget_folder_back_holo);
				} else {
				...
				// RemoteViews.setDrawableParameters方法是是private访问权限，需要注释掉
