...
public class PageDialogsHandler {
	 ...
	 * @param fromShowSSLCertificateOnError The flag that indicates whether this dialog was opened from the
	 *                                      SSL-certificate-on-error dialog or not. This is important, since
	 *                                      we need to know whether to return to the parent dialog or simply
	 *                                      dismiss.
	 * @param urlCertificateOnError         The URL that invokes SSLCertificateError. Null when
	 *                                      fromShowSSLCertificateOnError is false.
	 */
	 ...
	 * @param handler The SSL error handler responsible for cancelling the connection that resulted in an SSL
	 *                error or proceeding per user request.
