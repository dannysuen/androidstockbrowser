...
public class SearchEngineInfo {
	...
	/**
	 * Returns the URI for launching a web search with the given query (or null if there was no data
	 * available
	...
	/**
	 * Returns the URI for retrieving web search suggestions for the given query (or null if there was no
	 * data
	 * available for this search engine).
	 */
	...
	/**
	 * Formats a launchable uri out of the template uri by replacing the template parameters with actual
	 * values.
	 */
