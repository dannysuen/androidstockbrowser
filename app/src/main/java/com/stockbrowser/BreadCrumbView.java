...
/**
 * Simple bread crumb view Use setController to receive callbacks from user interactions Use pushView,
 * popView, clear, and getTopData to change/access the view stack
 */
