...
public class UrlUtils {
	...
	private final static String QUICKSEARCH_B = "http://www.baidu.com/s?work=%s";
	...
	/**
	 * Attempts to determine whether user input is a URL or search terms.  Anything with a space is passed to
	 * search. <p/> Converts to lowercase any mistakenly uppercased schema (i.e., "Http://" converts to
	 * "http://"
	 *
	...
	/**
	 * Attempts to determine whether user input is a URL or search terms.  Anything with a space is passed to
	 * search if canBeSearch is true. <p/> Converts to lowercase any mistakenly uppercased schema (i.e.,
	 * "Http://" converts to "http://"
	 *
	 * @param canBeSearch If true, will return a search url if it isn't a valid URL. If false, invalid URLs
	 *                    will return null
	 * @return Original or modified URL
	 */
	public static String smartUrlFilter(String url, boolean canBeSearch) {
		...
		if (canBeSearch) {
			return URLUtil.composeSearchUrl(inUrl, QUICKSEARCH_B, QUERY_PLACE_HOLDER);
		}
		return null;
	}
