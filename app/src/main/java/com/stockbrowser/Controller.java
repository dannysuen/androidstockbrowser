...
public class Controller implements WebViewController, UiController, ActivityController {
     ...
     *                   with {@link com.stockbrowser.compats.Browser#EXTRA_SHARE_FAVICON}
     * @param screenshot Bitmap of a screenshot of the page.  Stored in the
     *                   Intent with {@link com.stockbrowser.compats.Browser#EXTRA_SHARE_SCREENSHOT}
     */
...
//        String touchIconUrl = w.getTouchIconUrl();
    ...
    /**
     * Load the URL into the given Tab and update the title bar
