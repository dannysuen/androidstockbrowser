...
public class BookmarkUtils {
	...
	/**
	 * Creates an icon to be associated with this bookmark. If available, the apple touch icon will be used,
	 * else we draw our own depending on the type of "bookmark" being created.
	 */
	...
	private static Bitmap createIcon(Context context, Bitmap touchIcon,
									 Bitmap favicon, BookmarkIconType type, int iconDimension, int
											 iconDensity) {
	...
	static Intent createShortcutIntent(String url) {
		...
		shortcutIntent.putExtra(com.stockbrowser.compats.Browser.EXTRA_APPLICATION_ID, Long.toString
				(uniqueId));
