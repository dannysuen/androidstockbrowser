...
/**
 * This {@link BroadcastReceiver} handles clicks to notifications that downloads from the browser are in
 * progress/complete.  Clicking on an in-progress or failed download will open the download manager.  Clicking
 * on a complete, successful download will open the file.
 */
