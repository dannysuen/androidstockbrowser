...
import com.stockbrowser.addbookmark.FolderSpinner;
import com.stockbrowser.addbookmark.FolderSpinnerAdapter;
...
public class AddBookmarkPage extends Activity
	 ...
	 *
	 * @param cancel If true, the new folder is not created.  If false, the new folder is created and the
	 *                  user
	 *               is taken inside it.
	 */
	 ...
	 * @throws AssertionError if cursor is empty or there is no row with folderToFind as its "_id".
	 */
