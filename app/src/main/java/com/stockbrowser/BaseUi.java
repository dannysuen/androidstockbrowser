...
public abstract class BaseUi implements UI {
	...
	/**
	 * create a sub window container and webview for the tab Note: this methods operates through side-effects
	 * for now it sets both the subView and subViewContainer for the given tab
	 *
	...
	/**
	 * Suggest to the UI that the title bar can be hidden. The UI will then decide whether or not to hide
	 * based off a number of factors, such as if the user is editing the URL bar or if the page is loading
	 */
