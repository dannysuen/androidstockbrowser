...
import com.stockbrowser.stub.NullController;
...
public class BrowserActivity extends Activity {
	...
	/**
	 * onSaveInstanceState(Bundle map) onSaveInstanceState is called right before onStop(). The map contains
	 * the saved state.
	 */
	@Override
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		System.out.println("BrowserActivity.onPrepareOptionsMenu()");
