...
import com.stockbrowser.compats.*;
...
public class BrowserHistoryPage extends Fragment
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_to_bookmarks_menu_id:
                if (historyItem.isBookmark()) {
                    ...
                    com.stockbrowser.compats.Browser.saveBookmark(activity, title, url);
                }
                return true;
            case R.id.share_link_context_menu_id:
                com.stockbrowser.compats.Browser.sendString(activity, url,
            ...
            case R.id.delete_context_menu_id:
                com.stockbrowser.compats.Browser.deleteFromHistory(activity.getContentResolver(), url);
                return true;
    ...
    static class ClearHistoryTask extends Thread {
        ...
        @Override
        public void run() {
            com.stockbrowser.compats.Browser.clearHistory(mResolver);
        }
    }
