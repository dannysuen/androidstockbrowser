...
/**
 * This class implements sharing the URL of the currently shown browser page over NFC. Sharing is only active
 * when the activity is in the foreground and resumed. Incognito tabs will not be shared over NFC.
 */
@TargetApi(14)
