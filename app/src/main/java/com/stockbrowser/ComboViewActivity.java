...
public class ComboViewActivity extends FragmentActivity implements CombinedBookmarksCallbacks {
	 ...
	 * View or Intent that each tab will show.  This is not sufficient for switching between pages.  So
	 * instead we make the content part of the tab host 0dp high (it is not shown) and the TabsAdapter
	 * supplies its own dummy view to show as the tab content.  It listens to changes in tabs, and takes care
	 * of switch to the correct page in the ViewPager whenever the selected tab changes.
	 */
