...
/* package */ class ErrorConsoleView extends LinearLayout {
	...
	/**
	 * Sets the webview that this console is associated with. Currently this is used so we can call into
	 * webkit to evaluate JS expressions in the console.
	 */
	...
	/**
	 * This class extends ListView to implement the View that will actually display the set of errors
	 * encountered on the current page.
	 */
	private static class ErrorConsoleListView extends ListView {
		...
		/**
		 * This class is an adapter for ErrorConsoleListView that contains the error console message data.
		 */
