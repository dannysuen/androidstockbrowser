...
import com.stockbrowser.UrlUtils;
import com.stockbrowser.compats.Browser;
import com.stockbrowser.compats.Browser.BookmarkColumns;
import com.stockbrowser.provider.BrowserContract.Accounts;
import com.stockbrowser.provider.BrowserContract.Bookmarks;
import com.stockbrowser.provider.BrowserContract.ChromeSyncColumns;
import com.stockbrowser.provider.BrowserContract.Combined;
import com.stockbrowser.provider.BrowserContract.History;
import com.stockbrowser.provider.BrowserContract.Images;
import com.stockbrowser.provider.BrowserContract.Searches;
import com.stockbrowser.provider.BrowserContract.Settings;
import com.stockbrowser.widget.BookmarkThumbnailWidgetProvider;
...
public class BrowserProvider2 extends SQLiteContentProvider {
	...
	public static final String LEGACY_AUTHORITY = "stockbrowser";
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
		...
		switch (match) {
			...
			case SYNCSTATE: {
				// 注释掉
				//                return mSyncHelper.query(db, projection, selection, selectionArgs,
				// sortOrder);
				return null;
			}
			...
			case SYNCSTATE_ID: {
				...
				//                return mSyncHelper.query(db, projection, selectionWithId, selectionArgs,
				// sortOrder);
				return null;
			}
	...
	public int updateInTransaction(Uri uri, ContentValues values, String selection,
		...
		switch (match) {
			...
			case SYNCSTATE_ID: {
				...
				// " ")
				//                                + (selection == null ? "" : " AND (" + selection + ")");
				//                modified = mSyncHelper.update(mDb, values, selectionWithId, selectionArgs);
				break;
			}
	...
	final class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			if (oldVersion < 25) {
				...
				//                mSyncHelper.onAccountsChanged(db, new Account[] {}); // remove all sync
				// info
				onCreate(db);
			}
		}
