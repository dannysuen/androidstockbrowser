...
public class DownloadHandler {
	...
	/**
	 * Notify the host application a download should be done, or that the data should be streamed if a
	 * streaming viewer is available.
	 *
	...
	/**
	 * Notify the host application a download should be done, even if there is a streaming viewer available
	 * for thise type.
	 *
	 * @param activity           Activity requesting the download.
	 * @param url                The full url to the content that should be downloaded
