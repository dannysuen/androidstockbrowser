...
/**
 * Special Spinner class with its own callback for when the selection is set, which can be ignored by calling
 * setSelectionIgnoringSelectionChange
 */
public class FolderSpinner extends Spinner
	...
	/**
	 * Callback for knowing when the selection has been manually set.  Does not get called until the selected
	 * view has changed.
	 */
