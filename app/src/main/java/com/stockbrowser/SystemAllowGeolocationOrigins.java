...
/**
 * Manages the interaction between the secure system setting for default geolocation permissions and the
 * browser.
 */
class SystemAllowGeolocationOrigins {
	...
	/**
	 * Checks to see if the system setting has changed and if so, updates the Geolocation permissions
	 * accordingly.
	 */
	...
	/**
	 * Checks whether the setting has changed and installs an observer to listen for future changes. Must be
	...
	/**
	 * Removes geolocation permissions for the given origins, if they are allowed. If they are denied or not
	 * set, nothing is done.
	 */
